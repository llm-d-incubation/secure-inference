...
[![CI](https://github.com/llm-d/secure-inference/actions/workflows/ci-pr-checks.yaml/badge.svg)](https://github.com/llm-d/secure-inference/actions/workflows/ci-pr-checks.yaml)
...
```bash
# Clone the repo
git clone https://github.com/llm-d/secure-inference.git
cd secure-inference
